...
INSERT INTO logistic.route_info (id, name, description) VALUES (1, '一闪航空普货(包税)-QC', '平均时效 8 - 12 天');
INSERT INTO logistic.route_info (id, name, description) VALUES (2, '一闪航空特货(包税)-QC', '平均时效 15 - 25 天');
INSERT INTO logistic.route_info (id, name, description) VALUES (3, '一闪专线海运(包税)-QC', '平均时效 35 - 40 天');
INSERT INTO logistic.route_info (id, name, description) VALUES (4, '一闪敏感直邮(阳光清关)-QC', '平均时效 4 - 8 天');
